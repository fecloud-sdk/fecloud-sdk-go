...
func (o DownloadErrorlogRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DownloadErrorlogRequestBody struct{}"
	}

	return strings.Join([]string{"DownloadErrorlogRequestBody", string(data)}, " ")
}
