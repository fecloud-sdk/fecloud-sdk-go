...
func GenReqDefForCreateLinkAggregationGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/{project_id}/dcaas/link-aggregation-groups").
		WithResponse(new(model.CreateLinkAggregationGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteLinkAggregationGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/{project_id}/dcaas/link-aggregation-groups/{dc_lag_id}").
		WithResponse(new(model.DeleteLinkAggregationGroupResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DcLagId").
		WithJsonTag("dc_lag_id").
		WithLocationType(def.Path))
...
func GenReqDefForListLinkAggregationGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/dcaas/link-aggregation-groups").
		WithResponse(new(model.ListLinkAggregationGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowLinkAggregationGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/dcaas/link-aggregation-groups/{dc_lag_id}").
		WithResponse(new(model.ShowLinkAggregationGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateLinkAggregationGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/{project_id}/dcaas/link-aggregation-groups/{dc_lag_id}").
		WithResponse(new(model.UpdateLinkAggregationGroupResponse)).
		WithContentType("application/json")
