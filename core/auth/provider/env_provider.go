...
const (
	akEnvName            = "FECLOUD_SDK_AK"
	skEnvName            = "FECLOUD_SDK_SK"
	projectIdEnvName     = "FECLOUD_SDK_PROJECT_ID"
	domainIdEnvName      = "FECLOUD_SDK_DOMAIN_ID"
	securityTokenEnvName = "FECLOUD_SDK_SECURITY_TOKEN"
	idpIdEnvName         = "FECLOUD_SDK_IDP_ID"
	idTokenFileEnvName   = "FECLOUD_SDK_ID_TOKEN_FILE"
)
