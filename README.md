...
<h1 align="center">FE Cloud Go Software Development Kit (Go SDK)</h1>

The FE Cloud Go SDK allows you to easily work with FE Cloud services such as Elastic Compute Service (ECS) and
Virtual Private Cloud (VPC) without the need to handle API related tasks.

This document introduces how to obtain and use FE Cloud Go SDK.

## Requirements

- To use FE Cloud Go SDK, you must have FE Cloud account as well as the Access Key (AK) and Secret key (SK) of the FE
  Cloud account. You can create an AccessKey in the FE Cloud console.

- To use FE Cloud Go SDK to access the APIs of specific service, please make sure you do have activated the service
  in [FE Cloud console](https://console.prod-cloud-ocb.orange-business.com/) if needed.

- FE Cloud Go SDK requires go 1.14 or later, run command `go version` to check the version of Go.

## Install Go SDK

Run the following command to install FE Cloud Go SDK:

``` bash
# Install the library of FE Cloud Go SDK
go get github.com/fecloud-sdk/fecloud-sdk-go
```

## Code Example

- The following example shows how to query a list of VPCs in a specific region, you need to substitute your
  real `{service} "github.com/fecloud-sdk/fecloud-sdk-go/services/{service}/{version}"`
  for `vpc "github.com/fecloud-sdk/fecloud-sdk-go/services/vpc/v2"` in actual use, and initialize the client
...
import (
    "fmt"
    "github.com/fecloud-sdk/fecloud-sdk-go/core/auth/basic"
    "github.com/fecloud-sdk/fecloud-sdk-go/core/config"
    "github.com/fecloud-sdk/fecloud-sdk-go/core/httphandler"
    vpc "github.com/fecloud-sdk/fecloud-sdk-go/services/vpc/v2"
    "github.com/fecloud-sdk/fecloud-sdk-go/services/vpc/v2/model"
    "net/http"
)
...
the [CHANGELOG.md](https://github.com/fecloud-sdk/fecloud-sdk-go/blob/master/CHANGELOG.md).

## User Manual [:top:](#fe-cloud-go-software-development-kit-go-sdk)
...
``` go
import "github.com/fecloud-sdk/fecloud-sdk-go/core/config"
...
import (
	...
	service "github.com/fecloud-sdk/fecloud-sdk-go/services/service/v1"
	"github.com/fecloud-sdk/fecloud-sdk-go/services/service/v1/model"
)
